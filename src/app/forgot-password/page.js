...
const Page = () => {
  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center'>
        ...
        <div className='relative z-[44444] w-[90vw] lg:w-[40vw] h-max lg:h-[50vh] flex mx-auto rounded-lg border border-slate-300 my-auto items-center justify-center bg-white shadow-md p-4 lg:p-12'>
            <form className='w-full'>
                <h2 className='text-[28px] lg:text-[34px] font-bold'>Forgot password</h2>

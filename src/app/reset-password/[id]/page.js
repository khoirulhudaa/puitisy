...
const Page = () => {
  ...
  return (
    <div className='w-screen h-screen overflow-x-hidden flex items-center justify-center'>
        ...
        <div className='relative z-[44444] w-[90vw] lg:w-[40vw] h-max lg:min-h-[50vh] flex mx-auto rounded-lg border border-slate-300 items-center justify-center bg-white shadow-md p-4 lg:p-12'>
            <form className='w-full'>
                <h2 className='text-[28px] lg:text-[34px] font-bold'>Reset password</h2>
